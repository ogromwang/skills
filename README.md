...
| Skill | 描述 | 状态 |
|-------|------|------|
| [git-merge](git-merge/SKILL.md) | 安全地将当前分支合并到目标分支，并自动返回原分支 | ✅ 已完成 |
| [terminal-image](terminal-image/SKILL.md) | 在终端中显示图片，支持多种显示模式（Kitty/iTerm2图形协议、Unicode符号、ASCII艺术） | ✅ 已完成 |
...
- **2026-02-02**: 添加 terminal-image skill
